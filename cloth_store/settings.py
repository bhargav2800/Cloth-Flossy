...
INSTALLED_APPS = ['product.apps.ProductConfig', 'webstore.apps.WebstoreConfig', 'django.contrib.admin',
    ...
    'django.contrib.staticfiles', 'crispy_forms', 'phonenumber_field', ]
...
DATABASES = {# 'default': {
    ...
    'default': {'ENGINE': 'django.db.backends.postgresql_psycopg2', 'NAME': os.environ.get('DB_NAME'),
        'USER': os.environ.get('USER_NAME'), 'PASSWORD': os.environ.get('DB_PASS'), 'HOST': 'localhost',
        'PORT': '5432', }}
...
AUTH_PASSWORD_VALIDATORS = [{'NAME': 'django.contrib.auth.password_validation.UserAttributeSimilarityValidator', },
    ...
    {'NAME': 'webstore.validators.UppercaseValidator', }, {'NAME': 'webstore.validators.LowercaseValidator', },
    {'NAME': 'webstore.validators.SpecialcharValidator', }, {'NAME': 'webstore.validators.NumericValidator', },
...
MESSAGE_TAGS = {messages.DEBUG: 'alert-secondary', messages.INFO: 'alert-info', messages.SUCCESS: 'alert-success',
    messages.WARNING: 'alert-warning', messages.ERROR: 'alert-danger', }
